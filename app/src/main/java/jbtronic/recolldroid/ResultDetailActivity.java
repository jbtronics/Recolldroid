...
public class ResultDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab_result);
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putInt(ResultDetailFragment.ARG_ITEM_ID, getIntent().getIntExtra(ResultDetailFragment.ARG_ITEM_ID, 0));

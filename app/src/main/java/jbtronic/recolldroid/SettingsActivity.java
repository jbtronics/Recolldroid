...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    protected boolean isValidFragment(String fragmentName) {
        return PreferenceFragment.class.getName().equals(fragmentName)
                ...
                || ResultPreferenceFragment.class.getName().equals(fragmentName) ;
    }
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // guidelines.
            bindPreferenceSummaryToValue(findPreference("pref_key_server_addr"));
            bindPreferenceSummaryToValue(findPreference("pref_key_auth_user"));
            bindPreferenceSummaryToValue(findPreference("pref_key_path_file"));
            //bindPreferenceSummaryToValue(findPreference("pref_key_auth_pass"));
        }
    ...
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class ResultPreferenceFragment extends PreferenceFragment {
        @Override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.pref_results);
            setHasOptionsMenu(true);
